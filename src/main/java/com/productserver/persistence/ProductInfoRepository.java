...
public interface ProductInfoRepository extends CrudRepository<ProductInfo, Long> {
    ...
    @Query("  select a.productId as productInfoId, b.seq as productId, a.productOwner.userId as writerId, a.createDate as createDate, b.title as title, a.price * c.per1KRW as price, a.fee * c.per1KRW as fee, b.language as language, a.productStatus as status " +
            " from ProductInfo a, Product b " +
            " JOIN ExchangeRate c ON b.language = c.country "+
